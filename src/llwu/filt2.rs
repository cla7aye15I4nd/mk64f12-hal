...
pub type FILTSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u8, FILT2_SPEC, u8, FILTSEL_A, 4, O>;
...
pub type FILTE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, FILT2_SPEC, u8, FILTE_A, 2, O>;
...
pub type FILTF_W<'a, const O: u8> = crate::BitWriter<'a, u8, FILT2_SPEC, FILTF_A, O>;
