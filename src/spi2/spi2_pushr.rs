...
pub struct R(crate::R<SPI2_PUSHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI2_PUSHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI2_PUSHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI2_PUSHR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PUSHR` writer"]
pub struct W(crate::W<SPI2_PUSHR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI2_PUSHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI2_PUSHR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI2_PUSHR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TXDATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI2_PUSHR_SPEC, u16, u16, 16, O>;
...
pub type PCS0_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS0_A, O>;
...
pub type PCS1_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS1_A, O>;
...
pub type PCS2_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS2_A, O>;
...
pub type PCS3_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS3_A, O>;
...
pub type PCS4_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS4_A, O>;
...
pub type PCS5_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, PCS5_A, O>;
...
pub type CTCNT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, CTCNT_A, O>;
...
pub type EOQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, EOQ_A, O>;
...
pub type CTAS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI2_PUSHR_SPEC, u8, CTAS_A, 3, O>;
...
pub type CONT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI2_PUSHR_SPEC, CONT_A, O>;
...
#[doc = "PUSH TX FIFO Register In Master Mode\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi2_pushr](index.html) module"]
pub struct SPI2_PUSHR_SPEC;
impl crate::RegisterSpec for SPI2_PUSHR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi2_pushr::R](R) reader structure"]
impl crate::Readable for SPI2_PUSHR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi2_pushr::W](W) writer structure"]
impl crate::Writable for SPI2_PUSHR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PUSHR to value 0"]
impl crate::Resettable for SPI2_PUSHR_SPEC {
