...
pub struct R(crate::R<WORD012_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WORD012_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WORD012_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WORD012_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WORD012` writer"]
pub struct W(crate::W<WORD012_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WORD012_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WORD012_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WORD012_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_BYTE_3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD012_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD012_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD012_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD012_SPEC, u8, u8, 8, O>;
impl R {
