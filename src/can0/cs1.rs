...
impl From<crate::R<CS1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CS1_SPEC>> for W {
    #[inline(always)]
...
pub type TIME_STAMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS1_SPEC, u16, u16, 16, O>;
...
pub type DLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS1_SPEC, u8, u8, 4, O>;
...
pub type RTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS1_SPEC, bool, O>;
...
pub type IDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS1_SPEC, bool, O>;
...
pub type SRR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS1_SPEC, bool, O>;
#[doc = "Field `CODE` reader - Reserved"]
pub type CODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CODE` writer - Reserved"]
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS1_SPEC, u8, u8, 4, O>;
impl R {
