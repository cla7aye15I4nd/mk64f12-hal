...
pub struct R(crate::R<ID1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID1` writer"]
pub struct W(crate::W<ID1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID1_SPEC, u32, u32, 18, O>;
...
pub type STD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID1_SPEC, u16, u16, 11, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID1_SPEC, u8, u8, 3, O>;
impl R {
