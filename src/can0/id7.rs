...
pub struct R(crate::R<ID7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID7` writer"]
pub struct W(crate::W<ID7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID7_SPEC, u32, u32, 18, O>;
...
pub type STD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID7_SPEC, u16, u16, 11, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID7_SPEC, u8, u8, 3, O>;
impl R {
