...
pub struct R(crate::R<CS0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CS0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CS0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CS0` writer"]
pub struct W(crate::W<CS0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CS0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CS0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TIME_STAMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS0_SPEC, u16, u16, 16, O>;
...
pub type DLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS0_SPEC, u8, u8, 4, O>;
...
pub type RTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS0_SPEC, bool, O>;
...
pub type IDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS0_SPEC, bool, O>;
...
pub type SRR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS0_SPEC, bool, O>;
#[doc = "Field `CODE` reader - Reserved"]
pub type CODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CODE` writer - Reserved"]
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS0_SPEC, u8, u8, 4, O>;
impl R {
