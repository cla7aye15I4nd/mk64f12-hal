...
pub struct R(crate::R<WORD12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WORD12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WORD12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WORD12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WORD12` writer"]
pub struct W(crate::W<WORD12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WORD12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WORD12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WORD12_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_BYTE_7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD12_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD12_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD12_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD12_SPEC, u8, u8, 8, O>;
impl R {
