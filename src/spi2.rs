...
pub mod tcr;
#[doc = "SPI2_CTAR (rw) register accessor: an alias for `Reg<SPI2_CTAR_SPEC>`"]
pub type SPI2_CTAR = crate::Reg<spi2_ctar::SPI2_CTAR_SPEC>;
#[doc = "Clock and Transfer Attributes Register (In Master Mode)"]
pub mod spi2_ctar;
#[doc = "SPI2_CTAR_SLAVE (rw) register accessor: an alias for `Reg<SPI2_CTAR_SLAVE_SPEC>`"]
pub type SPI2_CTAR_SLAVE = crate::Reg<spi2_ctar_slave::SPI2_CTAR_SLAVE_SPEC>;
#[doc = "Clock and Transfer Attributes Register (In Slave Mode)"]
pub mod spi2_ctar_slave;
...
pub mod rser;
#[doc = "SPI2_PUSHR (rw) register accessor: an alias for `Reg<SPI2_PUSHR_SPEC>`"]
pub type SPI2_PUSHR = crate::Reg<spi2_pushr::SPI2_PUSHR_SPEC>;
#[doc = "PUSH TX FIFO Register In Master Mode"]
pub mod spi2_pushr;
#[doc = "SPI2_PUSHR_SLAVE (rw) register accessor: an alias for `Reg<SPI2_PUSHR_SLAVE_SPEC>`"]
pub type SPI2_PUSHR_SLAVE = crate::Reg<spi2_pushr_slave::SPI2_PUSHR_SLAVE_SPEC>;
#[doc = "PUSH TX FIFO Register In Slave Mode"]
pub mod spi2_pushr_slave;
