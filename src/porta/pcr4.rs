...
pub type PS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, PS_A, O>;
...
pub type PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, PE_A, O>;
...
pub type SRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, SRE_A, O>;
...
pub type PFE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, PFE_A, O>;
...
pub type ODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, ODE_A, O>;
...
pub type DSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, DSE_A, O>;
...
pub type MUX_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PCR4_SPEC, u8, MUX_A, 3, O>;
...
pub type LK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, LK_A, O>;
...
pub type IRQC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCR4_SPEC, u8, IRQC_A, 4, O>;
...
pub type ISF_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCR4_SPEC, ISF_A, O>;
...
#[doc = "`reset()` method sets PCR4 to value 0x0743"]
impl crate::Resettable for PCR4_SPEC {
    const RESET_VALUE: Self::Ux = 0x0743;
}
