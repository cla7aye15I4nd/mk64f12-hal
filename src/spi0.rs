...
pub mod tcr;
#[doc = "SPI0_CTAR (rw) register accessor: an alias for `Reg<SPI0_CTAR_SPEC>`"]
pub type SPI0_CTAR = crate::Reg<spi0_ctar::SPI0_CTAR_SPEC>;
#[doc = "Clock and Transfer Attributes Register (In Master Mode)"]
pub mod spi0_ctar;
#[doc = "SPI0_CTAR_SLAVE (rw) register accessor: an alias for `Reg<SPI0_CTAR_SLAVE_SPEC>`"]
...
pub mod rser;
#[doc = "SPI0_PUSHR (rw) register accessor: an alias for `Reg<SPI0_PUSHR_SPEC>`"]
pub type SPI0_PUSHR = crate::Reg<spi0_pushr::SPI0_PUSHR_SPEC>;
#[doc = "PUSH TX FIFO Register In Master Mode"]
pub mod spi0_pushr;
#[doc = "SPI0_PUSHR_SLAVE (rw) register accessor: an alias for `Reg<SPI0_PUSHR_SLAVE_SPEC>`"]
