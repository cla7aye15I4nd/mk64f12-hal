...
pub type RSTFLTSEL_R = crate::FieldReader<u8, RSTFLTSEL_A>;
...
pub type RSTFLTSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, RPFW_SPEC, u8, RSTFLTSEL_A, 5, O>;
impl<'a, const O: u8> RSTFLTSEL_W<'a, O> {
...
impl R {
    ...
    pub fn rstfltsel(&self) -> RSTFLTSEL_R {
        RSTFLTSEL_R::new(self.bits & 0x1f)
    }
}
impl W {
    #[doc = "Bits 0:4 - Reset Pin Filter Bus Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn rstfltsel(&mut self) -> RSTFLTSEL_W<0> {
        RSTFLTSEL_W::new(self)
    }
