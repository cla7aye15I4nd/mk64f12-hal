#[doc = "Register `CAU_LDR_CASR` writer"]
pub struct W(crate::W<CAU_LDR_CASR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAU_LDR_CASR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CAU_LDR_CASR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CAU_LDR_CASR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CAU_LDR_CASR_SPEC, IC_AW, O>;
...
pub type DPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CAU_LDR_CASR_SPEC, DPE_AW, O>;
...
pub type VER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CAU_LDR_CASR_SPEC, u8, VER_AW, 4, O>;
...
#[doc = "Status register - Load Register command\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cau_ldr_casr](index.html) module"]
pub struct CAU_LDR_CASR_SPEC;
impl crate::RegisterSpec for CAU_LDR_CASR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cau_ldr_casr::W](W) writer structure"]
impl crate::Writable for CAU_LDR_CASR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CAU_LDR_CASR to value 0x2000_0000"]
impl crate::Resettable for CAU_LDR_CASR_SPEC {
