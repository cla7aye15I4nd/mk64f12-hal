...
pub type BR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SPEC, u8, u8, 4, O>;
...
pub type DT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SPEC, u8, u8, 4, O>;
...
pub type ASC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SPEC, u8, u8, 4, O>;
...
pub type CSSCK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SPEC, u8, u8, 4, O>;
...
pub type PBR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SPI0_CTAR_SPEC, u8, PBR_A, 2, O>;
...
pub type PDT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SPI0_CTAR_SPEC, u8, PDT_A, 2, O>;
...
pub type PASC_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SPI0_CTAR_SPEC, u8, PASC_A, 2, O>;
...
pub type PCSSCK_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SPI0_CTAR_SPEC, u8, PCSSCK_A, 2, O>;
...
pub type LSBFE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SPEC, LSBFE_A, O>;
...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SPEC, CPHA_A, O>;
...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SPEC, CPOL_A, O>;
...
pub type FMSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SPEC, u8, u8, 4, O>;
...
pub type DBR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SPEC, DBR_A, O>;
