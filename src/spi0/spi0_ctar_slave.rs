...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SLAVE_SPEC, CPHA_A, O>;
...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI0_CTAR_SLAVE_SPEC, CPOL_A, O>;
...
pub type FMSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI0_CTAR_SLAVE_SPEC, u8, u8, 5, O>;
impl R {
