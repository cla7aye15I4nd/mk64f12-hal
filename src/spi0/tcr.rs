...
pub type SPI_TCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SPI_TCNT` writer - SPI Transfer Counter"]
pub type SPI_TCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_tcnt(&mut self) -> SPI_TCNT_W<16> {
        SPI_TCNT_W::new(self)
    }
